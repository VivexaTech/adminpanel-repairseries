...
const navItems = [
  ...
  { to: '/revisits', label: 'Revisits', icon: RotateCcw },
  { to: '/invoices', label: 'Invoices', icon: Receipt },
  { to: '/finance-reports', label: 'Finance Reports', icon: IndianRupee },
  { to: '/notifications', label: 'Notifications', icon: Megaphone },
  { to: '/paused-jobs', label: 'Paused Jobs', icon: PauseCircle },
  { to: '/location-history', label: 'Location History', icon: MapPinned },
  { to: '/services', label: 'Services', icon: Settings },
  { to: '/coming-soon-services', label: 'Coming Soon', icon: Sparkles },
  ...
  { to: '/offers', label: 'Offers (legacy)', icon: Tag },
...
export function AdminLayout({ children }) {
  ...
  const sectionTitle = (() => {
    ...
    const map = {
      ...
      'paused-jobs': 'Paused Service Jobs',
